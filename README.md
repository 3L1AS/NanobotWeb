...
Because this dashboard is decoupled from the main gateway, running it is incredibly simple. It securely mounts the Docker socket to natively execute commands inside your pre-existing nanobot container.

1. Ensure your original nanobot is already running.
